...
l1 = Letter.create(user: u1, letter_title: "College Friends", recipient_name: "Ethan", recipient_email: "ethan@gmail.com", letter_text: "Hey everyone, so... I did a thing...", signoff: "Matt")
l2 = Letter.create(user: u1, letter_title: "Julia - thank you", recipient_name: "Julia Pearlman", recipient_email: "julia@gmail.com", letter_text: "Hey Julia, so... I did a thing...", signoff: "Matt")

l3 = Letter.create(user: u2, letter_title: "Dave - sorry", recipient_name: "Dave Bendet", recipient_email: "dave@gmail.com", letter_text: "Hey Dave, so... I did a thing...", signoff: "Danny")
